                ...
                include: {
                    location: {
                        select: {
                            ...
                            googleReviews: true, retailSpace: true,
                            numberOfFloors: true, anchorTenants: true,
                            healthIndex: true, vacantUnits: true, vacantFloorspace: true,
                            percentMultiple: true, percentIndependent: true,
                            population: true, medianAge: true, avgHouseholdIncome: true,
                            website: true, instagram: true, facebook: true,
                        },
                    },
                },
            },
