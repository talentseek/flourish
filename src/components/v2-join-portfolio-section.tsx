    ...
    <section id="join-portfolio" className="py-16 bg-[#F7F4F2]">
      <div className="container mx-auto px-4">
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {[1, 2].map((i) => (
              <Card key={i} className="border-[#D8D8D6] overflow-hidden">
                <CardContent className="p-0">
                  <div className="aspect-video bg-[#D8D8D6] flex items-center justify-center">
                    <div className="text-center">
                      <Play className="h-12 w-12 text-[#E6FB60] mx-auto mb-2" />
                      <p className="text-sm text-[#4D4A46]">Centre walk around video {i}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
